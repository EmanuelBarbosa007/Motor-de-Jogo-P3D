...
#include <glm/gtx/quaternion.hpp> // Permite conversões diretas de Euler para Quaternions
...
namespace game_engine_p3d {
	...
	public:
		...
		// CORREÇÃO: Substituição da vec3 por um Quaternion inicializado como identidade
	...
	private:
		// Função auxiliar para recalcular a matriz
		void UpdateMatrix();
	};
}